    ...
    <div className="container mx-auto">
      <div className="lg:h-[750px] bg-zinc-200 overflow-hidden relative">
        <img
          src={bg}
          alt="female"
          className="absolute -right-[40%] xl:-right-[0%] lg:-right-[25%]"
        />
        <div className="h-full flex flex-col justify-center lg:px-16 py-8 px-2 text-left gap-3">
          <h1 className="lg:text-5xl font-semibold">Fall Season</h1>
          <h1 className="xl:text-8xl lg:text-6xl font-bold mb-4">Trending</h1>
          <div>
